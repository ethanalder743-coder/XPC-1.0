...
class Dashboard:
    ...
    async def state(self, request):
        ...
        return web.json_response({"commands": commands, "teams": teams, "logs": logs, "transfer_window_open": self.db.transfer_window_open(guild_id)})
